        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a href="index.html"><i class="la la-home"></i><span class="menu-title" data-i18n="eCommerce Dashboard">Properties Dashboard</span></a>
                </li>
                ...
                <li class=" nav-item {{ request()->is('dashbord') ? 'active' : '' }} "><a href="{{url('dashbord')}}"><i class="la la-th-large"></i><span class="menu-title" data-i18n="Shop">Dashbord</span></a>
                </li>
                <li class=" nav-item {{ request()->is('properties_all') ? 'active' : '' }}" > <a href="{{url('properties_all')}}"> <i class="la la-list"></i><span class="menu-title" data-i18n="Properties Detail">Properties Detail</span></a>
                </li>
                <li class=" nav-item {{ request()->is('category_all') ? 'active' : '' }}" > <a href="{{url('category_all')}}"> <i class="la la-list"></i><span class="menu-title" data-i18n="Properties Detail">Properties Category</span></a>
                </li>
                <li class=" nav-item"><a href="ecommerce-order.html"><i class="la la-check-circle-o"></i><span class="menu-title" data-i18n="Order">Logout</span></a>
                </li> 
